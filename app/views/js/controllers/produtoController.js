        ...
        columnDefs: [
            {
                ...
                enableSorting: false,
                cellTemplate:'<a role="button" data-toggle="modal" data-target="#modalComprar" class="table-icon" data-tipo="Editar" ng-click="grid.appScope.compra(row.entity)" data-keyboard="true"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>',
                width: 80
            },
            ...
            { field: 'value', displayName: 'Preço', minWidth:200 },
            {
                ...
                enableColumnMenu: false,
                enableSorting: false,
                cellTemplate:'<a role="button" data-toggle="modal" data-target="#modalDesejar" class="table-icon" data-tipo="Editar" ng-click="grid.appScope.compra(row.entity)" data-keyboard="true"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>',
                width: 80
            },
        ],
          data: []
